 ...
 * ```
 *
 * **Compression.** Plain XML and gzip are read directly. Wikimedia publishes `.bz2`, which the JDK cannot
 * decompress and which is not worth a dependency here: pipe it in instead, with `bzip2 -dc dump.xml.bz2 | …`,
 * or hand [pages] an already-decompressing stream.
 *
...
public object XmlDump {
     ...
     *
     * The sequence can be consumed once, and the stream is closed when it is exhausted or when iteration
     * stops.
     */
