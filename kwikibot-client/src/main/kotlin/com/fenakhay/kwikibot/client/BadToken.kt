 ...
 *
 * The transport hands error blocks back rather than throwing, so without this a stale token reads as an
 * ordinary refusal and the write is abandoned instead of retried. Every service that writes needs it, which
 * is why it does not live inside one of them.
 */
