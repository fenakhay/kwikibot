 ...
 *
 * Without this every write follows the account's preferences, and an account configured to watch what it
 ...
 *
 * [WatchMode.PREFERENCES] is what a wiki does unasked, so sending it would add a parameter to every write for
 * no effect.
 */
