 ...
 *
 * @param prefixes the namespace names that mean "category" on this wiki; the canonical English name by
 *   default, since the wikitext module knows nothing about any particular wiki.
 */
 ...
 *
 * A leading colon is stripped first: `[[:Category:Foo]]` links to the category rather than filing the page in
 * it, but it still names that category.
 */
 ...
 *
 * @param codes the language codes this wiki recognises. A prefix is only a language link if the wiki says so,
